...
class CanvasApp(App):
    ...
    def update_sig_m(self, *largs):
        if self.i == len(self.sctt.sig_m_K)-1:
            return False
        self.sig_line.points = self.list_tuple(self.sctt.x, self.sctt.sig_m_K[self.i])
        self.i += 1
    ...
    def cracking_wid(self):
        ...
        self.sig_mu_line.points = self.list_tuple(self.sctt.x, self.sctt.sig_mu_x)
    ...
    def curve_wid(self):
        ...
        self.eps_sig_line.points = self.list_tuple(self.sctt.eps_c_K, self.sctt.sig_c_K)
    ...
    def build(self):
        ...
        btn_animate = Button(text='animate',on_press=self.animate, size_hint=(0.4, 0.2))
        ...
        #curve panel
        btn_plot = Button(text='Plot', on_press=self.plot_eps_sig, size_hint=(0.4, 0.2))
